...
//                            driver.set(new RemoteWebDriver(new URL("http://localhost:44444/wd/hub"), DesiredCapabilities.firefox()));
...
//                            driver.set(new RemoteWebDriver(new URL("http://localhost:44444/wd/hub"), DesiredCapabilities.chrome()));
                        } catch (MalformedURLException e) {
                            e.printStackTrace();
                        }
                    } else {
